...
class Movies extends Component {
    ...
    render() { 
        ...
        const {pagesize, curruntPage, sortColomn} = this.state;
        ...
        return (
            <div className="row">
                ...
                <Pagination itemCount={totalCount} pageSize={pagesize} onPageChange={this.handlePageChange} curruntPage={curruntPage}/>
